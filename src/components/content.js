...
export function Content(project, regenerateApp, removeProject, projectDialog, sortProperty, setSort, sortDirection) {
  ...
  return div(
    ...
    Table(project, regenerateApp, showDialog, sortProperty, setSort, sortDirection),
    newButton,
  );
}
